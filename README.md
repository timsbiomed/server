...
Populate existing HAPI FHIR server on NCATS cloud with common terminologies and ontologies needed for translational science
Create a loader for RDF/OWL based content
Load corresponding data science ontologies relevant to CTSA
Create demonstration scripts of API services integrated into applications such as REDCap.
